...
Consider race and care.In this case, race's characters can be formed into a study, or care's characters can
be formed into race. Below is a java program to check if two strings are anagrams or not. */
...
public class PS_02 {
    public static void main(String[] args) {
        ...
        if (str1.length() == str2.length()) {// convert strings into char array
